...
* Fix: Sermon series now import their graphic from Planning Center. The series artwork was fetched with each episode but discarded, so synced series had no featured image (the sermon's own artwork was unaffected). Requires CP Sermons 1.6.3 or later. An image you set on a series by hand is never replaced.
