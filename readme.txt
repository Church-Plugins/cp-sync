...
* New: Sermon syncing from Planning Center Publishing to CP Library — episodes published to your Church Center library import as CP Library sermons with series, speakers, media URLs, and artwork. Includes a Sermons settings tab with filtering, and a Sync Sermons toggle on the Connect tab.
